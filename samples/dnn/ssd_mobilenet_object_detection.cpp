...
const float inScaleFactor = 0.007843;
...
int main(int argc, char** argv)
{
    ...
    {
        cropSize = Size(inVideoSize.height * WHRatio, inVideoSize.height);
    }
    else
    {
        cropSize = Size(inVideoSize.width, inVideoSize.width / WHRatio);
    }

    Rect crop(Point(0.5 * (inVideoSize.width - cropSize.width),
                    0.5 * (inVideoSize.height - cropSize.height)),
              cropSize);
